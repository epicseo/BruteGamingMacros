...
namespace BruteGamingMacros.Core.Utils
{
    public class AppConfig
    {
        ...
        // === LINKS & RESOURCES ===
        public static string GithubLink = "https://github.com/epicseo/BruteGamingMacros/releases";  // Repository releases
        public static string LatestVersionURL = "https://api.github.com/repos/epicseo/BruteGamingMacros/releases/latest";  // API endpoint for latest version
